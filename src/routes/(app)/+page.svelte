...
>
	<BackgroundBlob color="red" bind:this={blob} />
	<div class="grid aspect-square h-svh grid-cols-3 grid-rows-3 gap-4 p-4">
		<div class="col-span-2 flex flex-col gap-4">
			<div class="bg-bg border-border rounded-lg border px-2 pt-2">
				<span class="text-accent text-4xl">Gabriel Jõe</span>
		...
		<div class="bg-bg border-border relative rounded-lg border">
		...
		<div class="bg-bg border-border relative rounded-lg border p-[10px]">
			<div class="tech-circle h-4/5 w-4/5">
				<div class="tech-circle-item" style="--deg: {(360 / 8) * 0}deg;">
					<svg class="p-1" height="48" width="48" viewBox="0 0 128 128">
						<path
				...
				<div class="tech-circle-item" style="--deg: {(360 / 8) * 1}deg;">
					<svg class="p-1" height="48" width="48" viewBox="0 0 128 128">
						<path
							fill="#007acc"
				...
				<div class="tech-circle-item" style="--deg: {(360 / 8) * 2}deg;">
					<svg class="p-1" height="48" width="48" viewBox="0 0 128 128">
						<path
							fill="#F0DB4F"
				...
				<div class="tech-circle-item" style="--deg: {(360 / 8) * 3}deg;">
					<svg class="p-1" height="48" width="48" viewBox="0 0 128 128">
						<path
				...
				<div class="tech-circle-item" style="--deg: {(360 / 8) * 4}deg;">
					<svg class="p-1" height="48" width="48" viewBox="0 0 128 128">
						<path
							fill="#0074BD"
				...
				<div class="tech-circle-item" style="--deg: {(360 / 8) * 5}deg;">
					<svg class="p-1" height="48" width="48" viewBox="0 0 128 128">
						<path
				...
				<div class="tech-circle-item" style="--deg: {(360 / 8) * 6}deg;">
					<svg
						class="p-1"
						height="48"
						width="48"
						viewBox="3.48338 2.81493 121 122.4"
					>
						<path
						...
						/>
						<path
							d="M122.281 48.811C120.183 40.363 116.178 34 107.682 34h-10.682V46.981c0 10.05-8.794 18.019-18.511 18.019H49.33C41.342 65 35 72.326 35 80.326v27.8c0 7.91 6.745 12.564 14.462 14.834 9.242 2.717 17.994 3.208 29.051 0C85.862 120.831 93 116.549 93 108.126V97H64v-4h43.682c8.484 0 11.647-5.776 14.599-14.66 3.047-9.145 2.916-17.799 0-29.529zm-41.955 55.606c3.027 0 5.479 2.479 5.479 5.547 0 3.076-2.451 5.579-5.479 5.579-3.015 0-5.478-2.502-5.478-5.579 0-3.068 2.463-5.547 5.478-5.547z"
							fill="#ffcf46"
						/>
					</svg>
				</div>
				<div class="tech-circle-item" style="--deg: {(360 / 8) * 7}deg;">
					<svg class="p-1" height="48" width="48" viewBox="0 0 128 128">
						<g fill="#61DAFB"
			...
			<div class="tech-circle reverse h-1/3 w-1/3">
				<div class="tech-circle-item" style="--deg: {(360 / 2) * 0}deg;">
					<svg class="p-1" height="48" width="48" viewBox="0 0 128 128">
						<path
							fill="#F34F29"
				...
				<div class="tech-circle-item" style="--deg: {(360 / 2) * 1}deg;">
					<svg
				...
				<div class="tech-circle-item" style="--deg: {(360 / 3) * 0}deg;"></div>
			</div>
		</div>
		<div
		...
		<div
			class="bg-bg border-border text-text-muted col-span-2 flex flex-col gap-1 rounded-lg border p-[10px]"
		>
			...
			<div class="flex items-center justify-between">
				...
				<div class="text-text text-end">Junior Software Developer</div>
			</div>
		</div>
	</div>
</div>
...
<style>
	...
	:global(.tech-circle.reverse .tech-circle-item svg) {
